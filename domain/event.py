...
# DomainEvent is an alias for Event
DomainEvent = Event


# Factory functions for creating specific event types
def create_intent_created_event(
    goal: str,
    organization_id: Optional[str] = None,
    actor_id: Optional[str] = None,
    description: str = "",
...
def create_workflow_state_changed_event(
    workflow_id: str,
    new_state: str,
    organization_id: Optional[str] = None,
    actor_id: Optional[str] = None,
...
def create_policy_violated_event(
    policy_id: str,
    policy_name: str,
    violation_type: str,
    message: str,
...
def create_authorization_denied_event(
    decision_id: str,
    actor_id: str,
    action: str,
    resource_type: str,
