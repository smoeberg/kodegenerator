...
class EventType(Enum):
    ...
    PROJECT_CREATED = auto(); PROJECT_LAUNCH_REQUESTED = auto(); PROJECT_SCOPE_ACTIVATED = auto()
    PROJECT_COMPLETION_REQUESTED = auto(); PROJECT_COMPLETED = auto(); PROJECT_CANCELLED = auto(); PROJECT_ARCHIVED = auto(); PROJECT_CONTINUED = auto()
