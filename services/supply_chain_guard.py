...
class SupplyChainGuard:
    ...
    def audit_dependencies(self, manifest: str | Path | Mapping[str, Any]) -> AuditReport:
        ...
        for package, declared in declarations.items():
            ...
            if version and self._version_lt(version, vulnerable):
                findings.append(DependencyFinding(package, declared, cve_id, fixed, f"versions below {vulnerable} are vulnerable"))
