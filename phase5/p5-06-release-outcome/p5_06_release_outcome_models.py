...
class ReleaseOutcomeRecord:
    ...
    def __post_init__(self) -> None:
        required = (self.outcome_id, self.dispatch_id, self.finalization_fingerprint, self.outcome_fingerprint, self.external_reference, self.release_reference)
        if not all(required):
        ...
        object.__setattr__(self, "outcome_record_fingerprint", _fingerprint({
